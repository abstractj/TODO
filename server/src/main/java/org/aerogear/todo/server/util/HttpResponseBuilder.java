...
public class HttpResponseBuilder {
    ...
    public Response createResponse() {
        ...
        if (identity.isLoggedIn()) {
            ...
            Collection<String> roles = identity.getUserContext().getRoleNames();
            aeroGearCredential = new AeroGearCredential(identity.getUserContext().getUser().getId(), LOGGED, roles);
        }
